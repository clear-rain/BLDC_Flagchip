#ifndef _DEVICE_FEATURES_FC4150F512_SMISC_COMMON_H_
#define _DEVICE_FEATURES_FC4150F512_SMISC_COMMON_H_
...
#define SMISC_ROM_CLOCK_GATING_SUPPORT (0u)
...
#define SMISC_ALON32KSOURCE_SELECT_SUPPORT  (0u)
#endif
