#ifndef _DEVICE_FEATURES_FC4150F2MBS2P176T1A_H_
#define _DEVICE_FEATURES_FC4150F2MBS2P176T1A_H_
...
PORT_E28MuxType      ePortE28Mode;
PORT_E29MuxType      ePortE29Mode;
PORT_E30MuxType      ePortE30Mode;
PORT_E31MuxType      ePortE31Mode;
Port_PinModeType     u32PortPinMode;
} Port_PinMuxType;

/*********************** GPIO Features ****************************/
/** @brief PortA Pin MASK structure */
#define PORTA_PIN_MASK     (uint32_t)(0xffffffffu)
/** @brief PortB Pin MASK structure */
#define PORTB_PIN_MASK     (uint32_t)(0xffffffffu)
/** @brief PortC Pin MASK structure */
#define PORTC_PIN_MASK     (uint32_t)(0xffffffffu)
/** @brief PortD Pin MASK structure */
#define PORTD_PIN_MASK     (uint32_t)(0xffffffffu)
/** @brief PortE Pin MASK structure */
#define PORTE_PIN_MASK     (uint32_t)(0xffffffffu)
...
#endif /* _DEVICE_FEATURES_FC4150F2MBS2P176T1A_H_ */
