#ifndef _DEVICE_FEATURES_FC4150512_FLASH_COMMON_H_
#define _DEVICE_FEATURES_FC4150512_FLASH_COMMON_H_
/*********************** FLASH Features ****************************/

#define FLASHDRV_ADDR            0x01817000U

#define FC4150_512K_ECC_TEST                      STD_ON

#define DFLASH_SUPPORT                            STD_OFF

#define PFLASH_FINE_SUPPORT                       STD_ON

#define FLASH_API_EXTENDED_SUPPORT                STD_OFF
...
/** PFlash total size */
#define PFLASH_SIZE                               0x80000U
/** PFlash start address */
#define PFLASH_ADDR_START                         0x00U
/** Flash bank size */
#define PFLASH_BANK_SIZE                          0x40000U
/** Flash 256K size */
#define FLASH_256KB_SIZE                          0x40000U
/** Flash phantom offset */
#define PFLASH_PHANTOM_OFFSET                     (PFLASH_BANK_SIZE - FLASH_256KB_SIZE)
/** Flash end address */
#define PFLASH_ADDR_END                           0x7FFFFu
/** Two PFlash Bank, every bank is 256KB */
#define PFLASH_BANK_NUM                           0x02U
/** PFlash Bank 0 size */
#define PFLASH_BANK0_SIZE                         0x40000U
/** PFlash Bank1 size */
#define PFLASH_BANK1_SIZE                         0x40000U
/** Bank 0 start address */
#define PFLASH_BANK0_START                        0x00U
/** Bank 0 end address */
#define PFLASH_BANK0_END                          0x3FFFFu
/** Bank 1 start address */
#define PFLASH_BANK1_START                        0x40000U
/** Bank 1 end address */
#define PFLASH_BANK1_END                          0x7FFFFu
