#ifndef _DEVICE_FEATURES_FC4150F1MBS2P100T1A_H_
#define _DEVICE_FEATURES_FC4150F1MBS2P100T1A_H_

#include "FC4150F1M_A_Common_feature.h"
...
#define PORTA_PIN_MASK     (uint32_t)(0x3ffffu)
...
#endif /* _DEVICE_FEATURES_FC4150F1MBS2P100T1A_H_ */
