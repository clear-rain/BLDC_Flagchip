#ifndef _DEVICE_FEATURES_FC4150F1MBS1P144T1B_H_
#define _DEVICE_FEATURES_FC4150F1MBS1P144T1B_H_

#include "FC4150F1M_B_Common_feature.h"
/*********************** COR Features ****************************/
/** The module CORDIC is supported or not .
 * This module is available on FC4150F1M_B only.*/
#define CORDIC_MODULE_SUPPORT                   (1u)
/*********************** FLEXCAN Features ****************************/
/** Number of instances of the FLEXCAN module. */
#define FLEXCAN_INSTANCE_COUNT                   (3u)

#define FLEXCAN_GATE_ENABLE                      1U
...
/*********************** FREQM Features ****************************/
/** FREQM module is supported or not.
 * This module is available on FC4150F1M_B only.*/
#define FREQM_MODULE_SUPPORT                     (1u)
...
#undef  INTERRUPT_INACTIVE_MODE_SUPPORT
#define INTERRUPT_INACTIVE_MODE_SUPPORT          (1u)

/*********************** SMISC Features ****************************/


/*********************** FLASH Features ****************************/
///** Flash ECC Format  0.512K 1.1MB 2.1M 2M. */
#define FLASH_ECC_FORMAT  1u
#define FLASH_TYPE_FC150
...
#endif /* _DEVICE_FEATURES_FC4150F1MBS1P144T1B_H_ */
