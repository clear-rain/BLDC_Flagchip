#ifndef _DEVICE_FEATURES_FC4150F1M__S_TRGSEL_COMMON_H_
#define _DEVICE_FEATURES_FC4150F1M__S_TRGSEL_COMMON_H_
/*********************** Trgsel Features ****************************/
#define TRGSEL_INSTANCE_COUNT                                  (3u)
#define TRGSEL_BASE_ADDRS                        {TRGSEL0_BASE, TRGSEL1_BASE, TRGSEL2_BASE}
/** Array initializer of TRGSEL peripheral base pointers */
#define TRGSEL_BASE_PTRS                         {TRGSEL0, TRGSEL1, TRGSEL2}
