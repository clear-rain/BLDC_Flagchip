...
LOCAL_INLINE
void Motor_Voltage_Ramp(MotorFocStruct *foc_str)
{
...
//        Motor_Svpwm1(&foc_str->motor_alpha_beta_voltage, &foc_str->motor_svpwm);
//        Motor_Svpwm2(&foc_str->motor_alpha_beta_voltage, &foc_str->motor_svpwm);
