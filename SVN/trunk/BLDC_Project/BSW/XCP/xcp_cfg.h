...
//#define XCP_ENABLE_DAQ_TIMESTAMP
  ...
  #define kXcpDaqTimestampUnit DAQ_TIMESTAMP_UNIT_100MS
  #ifdef TRIBOARD_TC1797
    #define kXcpDaqTimestampTicksPerUnit 10  // 180MHz/4=45MHz -> 22,222ns * 512 = 11377,7777664 (Triboard TC1797) Error 0.002%
  #else
