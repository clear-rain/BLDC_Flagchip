...
static uint8 xcpCalPage; /* 0-Ram,1-Flash */
#endif
...
| DESCRIPTION:      
******************************************************************************/
uint8 ApplXcpCopyCalPage(uint8 srcSeg, uint8 srcPage, uint8 destSeg, uint8 destPage)
{
...
| DESCRIPTION:      
******************************************************************************/
void ApplXcpSetFreezeMode( uint8 segment, uint8 mode )
{
  /* something has to be done here */
}
...
| DESCRIPTION:      
******************************************************************************/
uint8 ApplXcpGetFreezeMode( uint8 segment )
{
  /* something has to be done here */
...
******************************************************************************/
 ...
 /* defined as macro */
#else
MTABYTEPTR ApplXcpGetPointer( uint8 addr_ext, uint32 addr )
{
...
******************************************************************************/
void XCP_FAR ApplXcpWrite( uint32 addr, uint8 data )
{
  #if defined ( C_COMP_COSMIC_MCS12X_MSCAN12 )
  /* X: Higher Word Address */
  /* D: Lower Word Address */
...
******************************************************************************/
tXcpChecksumAddType ApplXcpReadChecksumValue( uint32 addr )
{
...
| DESCRIPTION:      
******************************************************************************/
uint8 ApplXcpCalculateChecksum( ROMBYTEPTR pMemArea, BYTEPTR pRes, uint32 length )
{
...
******************************************************************************/
uint8 ApplXcpCalibrationWrite(MTABYTEPTR addr, uint8 size, const BYTEPTR data)
{
  while(size > (uint8)0)
  {
    *addr = *data;
...
******************************************************************************/
uint8 ApplXcpCalibrationRead(MTABYTEPTR addr, uint8 size, BYTEPTR data)
{
  while(size > (uint8)0)
  {
    *data = *addr;
...
******************************************************************************/
uint8 ApplXcpGetSeed( const uint8 resource, uint8 *seed )
{
  /* Store resource mask */
...
******************************************************************************/
uint8 ApplXcpUnlock( const uint8 *key, const uint8 length )
{
  /*
    Ckeck the key
...
******************************************************************************/
uint32 ApplXcpGetIdData( MTABYTEPTR *pData, uint8 id )
{
  switch( id )
...
******************************************************************************/
uint8 ApplXcpUserService( const BYTEPTR pCmd )
{
