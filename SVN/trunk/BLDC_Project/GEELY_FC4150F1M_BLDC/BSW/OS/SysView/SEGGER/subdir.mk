...
BSW/OS/SysView/SEGGER/%.o: ../BSW/OS/SysView/SEGGER/%.S BSW/OS/SysView/SEGGER/subdir.mk
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -O1 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wunused -Wuninitialized -Wall -Wextra -Wmissing-declarations -Wconversion -Wpointer-arith -Wshadow -Wlogical-op -Wfloat-equal  -g3 -x assembler-with-cpp -DDEBUG -DECU_ADDRESS_PDM_FL -DTRACE -DSTART_FROM_FLASH -DMCU_FC4150_512K=1 -DMCU_FC4150_2M=2 -DMCU_FC4150_1M_A=3 -DMCU_FC4150_1M_B=4 -DMCU_FC4150_1M_S=5 -DDEVICE_TYPE=MCU_FC4150_1M_B -DECU_ADDRESS_BLDC -DIMU_SPI_COMM -DFOC_HALL_DISABLE -I"D:\Project\all_Project\BLDC\SVN\trunk\BLDC_Project\BSW\OS\SysView\Config" -I"D:\Project\all_Project\BLDC\SVN\trunk\BLDC_Project\BSW\OS\SysView\Sample\FreeRTOSV10.4" -I"D:\Project\all_Project\BLDC\SVN\trunk\BLDC_Project\BSW\OS\SysView\SEGGER" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
