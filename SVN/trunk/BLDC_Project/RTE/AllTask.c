...
static void ASWTask_100ms( void *pvParameters)
{
    ...
    static uint8_t ui8NvmWriteCnt = 1u;
...
//        if (ui8NvmWriteCnt)
//        {
//            if (ui8NvmWriteCnt == 30)
//            {
//                ui8NvmWriteCnt = 0u;
//
//                NvMEncoderStroke[0] = 100;
//                NvMEncoderStroke[1] = 99;
//                NVM_SetBlockWriteFlag(EncoderStrokeId);
//                NVM_WriteAll();
//            }
//            else
//            {
...
//        }
        ...
        // for(u8Count = 0; u8Count < 50; u8Count++)
        // {
        //     vTaskDelayUntil(&xNextWakeTime, TASK_DELAY_100MS);
        // }

        // if(ui8_studyFlag == 0)
        // {
        //     IMU_LearnProcessTrigger();
        //     ui8_studyFlag = 1;
        // }

        //  Cdd_SbcModeSet(e_CDD_SBC_SLEEP_MODE);   // turn off VCC1 and VCC2,   after calling this should wait 10ms
        //  Cdd_SbcModeSet(e_CDD_SBC_STOP_MODE);    // turn off VCC2
        //  Cdd_SbcModeSet(e_CDD_SBC_RESET_MODE);    // restart SBC and reset MCU
