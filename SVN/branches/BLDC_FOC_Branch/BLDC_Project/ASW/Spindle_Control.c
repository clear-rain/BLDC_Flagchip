...
float MotorSpeedRefTest = 0.f;
void MotorSpeedTest(void)
{
	static uint16_t MotorSpeedRefTestCnt = 0u;

	MotorSpeedRefTestCnt++;

	if(MotorSpeedRefTestCnt > 100u)
	{
		MotorSpeedRefTestCnt = 0u;
	}

	MotorSpeedRefTest = arm_sin_f32(((float)MotorSpeedRefTestCnt)/100.f*3.1415926f)*2000.f + 500.f;

	MotorAPI_SpeedSetRPM(MotorSpeedRefTest);
}
