#ifndef _DEVICE_FEATURES_FC4150F2M__PORT_COMMON_H_
#define _DEVICE_FEATURES_FC4150F2M__PORT_COMMON_H_
...
typedef enum
{
PORTB_22_CMP1_IN4 = 0U,
PORTB_22_GPIO = 1U,
PORTB_22_FTU_FLT8 = 2U,
PORTB_22_MII_CRS = 3U,
PORTB_22_FTU6_CH6 = 4U,
...
typedef enum
{
PORTC_13_ADC1_SE15_CMP2_IN0 = 0U,
PORTC_13_GPIO = 1U,
...
{
PORTC_22_GPIO = 1U,
PORTC_22_FTU7_CH0 = 2U,
PORTC_22_FCSPI2_SOUT = 4U,
} PORT_C22MuxType;
...
/** @brief PORTD14 Mode enumeration */
typedef enum
{
PORTD_14_GPIO = 1U,
PORTD_14_FTU6_CH1 = 2U,
} PORT_D14MuxType;
...
typedef enum
{
PORTD_23_ADC0_SE25_CMP2_IN7 = 0U,
PORTD_23_GPIO = 1U,
...
/** @brief PORTE28 Mode enumeration */
typedef enum
{
PORTE_28_GPIO = 1U,
PORTE_28_FTU6_CH4 = 2U,
PORTE_28_SCG_CLKOUT = 3U,
} PORT_E28MuxType;
...
/** @brief PORTE30 Mode enumeration */
typedef enum
{
PORTE_30_GPIO = 1U,
PORTE_30_FTU6_CH6 = 2U,
} PORT_E30MuxType;

/** @brief PORTE31 Mode enumeration */
typedef enum
{
PORTE_31_GPIO = 1U,
PORTE_31_FTU6_CH5 = 2U,
} PORT_E31MuxType;
