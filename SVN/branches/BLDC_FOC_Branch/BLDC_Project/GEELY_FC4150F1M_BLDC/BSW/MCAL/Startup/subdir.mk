...
C_SRCS += \
../BSW/MCAL/Startup/system_init.c 

S_UPPER_SRCS += \
../BSW/MCAL/Startup/startup_FC4150.S 

OBJS += \
./BSW/MCAL/Startup/startup_FC4150.o \
./BSW/MCAL/Startup/system_init.o 

C_DEPS += \
./BSW/MCAL/Startup/system_init.d 


# Each subdirectory must supply rules for building sources it contributes
BSW/MCAL/Startup/%.o: ../BSW/MCAL/Startup/%.S BSW/MCAL/Startup/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: GNU Arm Cross Assembler'
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -O1 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wunused -Wuninitialized -Wall -Wextra -Wmissing-declarations -Wconversion -Wpointer-arith -Wshadow -Wlogical-op -Wfloat-equal  -g3 -x assembler-with-cpp -DDEBUG -DECU_ADDRESS_PDM_FL -DTRACE -DSTART_FROM_FLASH -DMCU_FC4150_512K=1 -DMCU_FC4150_2M=2 -DMCU_FC4150_1M_A=3 -DMCU_FC4150_1M_B=4 -DMCU_FC4150_1M_S=5 -DDEVICE_TYPE=MCU_FC4150_1M_B -DECU_ADDRESS_BLDC -DIMU_SPI_COMM -DFOC_HALL_DISABLE -I"E:\Code\BLDC_POD\SourceCode\branches\BLDC_FOC_Branch\BLDC_Project\BSW\CompatibleInfo" -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '

BSW/MCAL/Startup/%.o: ../BSW/MCAL/Startup/%.c BSW/MCAL/Startup/subdir.mk
	@echo 'Building file: $<'
